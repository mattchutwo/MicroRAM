; ModuleID = 'heartbleed.c'
source_filename = "heartbleed.c"
...
; <label>:22:                                     ; preds = %10
  ...
  %24 = call i32 @strcmp(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i8* %23)
  %25 = icmp eq i32 %24, 0
...
; <label>:29:                                     ; preds = %22
  ...
  call void @write_response_to_network(i32 %30, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 10)
  br label %33

; <label>:31:                                     ; preds = %22
  %32 = load i32, i32* %3, align 4
  call void @write_response_to_network(i32 %32, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i32 19)
  br label %33

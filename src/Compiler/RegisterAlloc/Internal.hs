...
writeRegistersMRIInstruction (MRAM.Icmpe r1 op) = mempty
writeRegistersMRIInstruction (MRAM.Icmpa r1 op) = mempty
writeRegistersMRIInstruction (MRAM.Icmpae r1 op) = mempty
writeRegistersMRIInstruction (MRAM.Icmpg r1 op) = mempty
writeRegistersMRIInstruction (MRAM.Icmpge r1 op) = mempty
